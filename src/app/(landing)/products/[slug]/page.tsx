...
export default async function ProductDetailPage({ params }: PageProps) {
  ...
  const productDescription = toPlainText(product.description) || undefined;
  const productImage = safeImageUrl(product.images?.[0], 1200, 630) || undefined;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 md:py-12 flex flex-col gap-10">
      ...
      <Suspense fallback={<ProductDetailSkeleton />}>
        ...
        {/* Application, Salient Features & Specifications */}
