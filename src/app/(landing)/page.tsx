...
import { OtherClientsData } from "@/components/sections/other-clients/other-clients-data";
import { OtherClientsSkeleton } from "@/components/sections/other-clients/other-clients-skeleton";
...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-20 md:gap-28 lg:gap-36 pb-20 w-full max-w-7xl mx-auto px-4">
      ...
      <Suspense fallback={<OtherClientsSkeleton />}>
        <OtherClientsData />
      </Suspense>
