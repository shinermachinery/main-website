...
export const siteConfig = {
  ...
  social: {
    ...
    instagram: "https://instagram.com/shinermachinery?igshid=NjIwNzIyMDk2Mg==",
...
export const pageMetadata = {
  ...
  aboutTeam: createPageMetadata(
    "Our Team",
    "Meet the people behind Shiner who make precision engineering possible. Our skilled team drives innovation and quality.",
    ["team", "engineers", "people"],
    "/about/team",
  ),
