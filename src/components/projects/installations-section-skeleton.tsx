  ...
  return (
    <section className="flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col gap-4">
        <div className="h-12 bg-zinc-200 rounded-md w-96 animate-pulse" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {SKELETON_IDS.slice(0, 3).map((id) => (
          <div key={id} className="flex flex-col gap-6">
            {/* Image Skeleton */}
            <div className="h-[480px] w-full rounded-[24px] bg-zinc-200 animate-pulse" />
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <div className="h-7 bg-zinc-200 rounded-md w-3/4 animate-pulse" />
                <div className="h-5 bg-zinc-200 rounded-md w-1/2 animate-pulse" />
              </div>
            </div>
          </div>
        ))}
