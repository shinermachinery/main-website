        ...
        <div className="max-w-7xl mx-auto space-y-24">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 items-start">
            ...
            <div className="flex-1">
              <h2 id="about-heading" className="text-[32px] leading-[42px] font-normal text-gray-900 tracking-[-0.5px] max-w-sm">
            ...
            <div className="flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
                ...
                <div className="space-y-3">
                  ...
                  <h4 className="text-sm font-semibold text-gray-900">Highest Precision Components</h4>
                  <p className="text-sm leading-relaxed font-normal text-gray-600">engineered for accurate, consistent performance.</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <h4 className="text-sm font-semibold text-gray-900">24/7 Support & Service</h4>
                  <p className="text-sm leading-relaxed font-normal text-gray-600">engineered for accurate, consistent performance.</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <h4 className="text-sm font-semibold text-gray-900">Productivity Focused</h4>
                  <p className="text-sm leading-relaxed font-normal text-gray-600">engineered for accurate, consistent performance.</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <h4 className="text-sm font-semibold text-gray-900">Global Reach, Local Support</h4>
                  <p className="text-sm leading-relaxed font-normal text-gray-600">engineered for accurate, consistent performance.</p>
                </div>
              </div>
            </div>
