...
export function BrandStoryGrid({ teamMembers }: BrandStoryGridProps) {
  ...
  return (
    <section className="py-24 md:py-32 bg-white" aria-labelledby="brand-story-heading">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start mb-10">
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-plus-jakarta-sans)" }}
            >
              With decades of experience in industrial fabrication systems, Shiner
              Machinery combines precision engineering with world-class support. We
              empower fabricators globally to build faster, cleaner, and smarter.
            </p>
          </div>
