    ...
    <footer className="bg-secondary border-t border-border">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Contact & Social */}
          <div className="space-y-4">
            <h4 className="font-bold text-primary">Connect With Us</h4>
            <p className="text-sm font-semibold text-primary">
              Shiner Machinery Private Limited
            </p>
        ...
        {offices.length > 0 && (
          <div className="mb-12 pt-8 border-t border-border">
            <h4 className="font-bold text-primary mb-6">Our Offices</h4>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-medium text-muted-foreground">
            <p>
              © {currentYear} Shiner Machinery Private Limited. All rights reserved.
            </p>
          </div>
        </div>
      </div>
